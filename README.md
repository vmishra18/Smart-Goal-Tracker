# Smart-Goal-Tracker
A ‘SMART GOAL TRACKER’ will help resolve all problems that an organisation faces in its day-to-day operations. It's a simple web site with filtering capability as well as graphically plotting the data as per the selected filters to provide more insights on the overall data.
